...
const menuItems = [
    { name: 'Features', href: '/start' },
    { name: 'Solution', href: '/start' },
    { name: 'Pricing', href: '/start' },
    { name: 'About', href: '/start' },
]
...
const Logo = ({ className }: { className?: string }) => {
    return (
        <div className={cn('flex items-center gap-2.5 select-none', className)}>
            <img src="/xite-logo.png" alt="XITE Logo" className="h-7 w-7 object-contain rounded-lg shadow-sm" />
            <span className="font-extrabold text-xl tracking-tight text-white font-sans">XITE</span>
        </div>
    )
}
