...
<section style="background: #000000; color: #ffffff; padding: 80px 24px; text-align: center; font-family: system-ui, -apple-system, sans-serif; width: 100%; box-sizing: border-box;">
  <div style="max-width: 900px; margin: 0 auto;">
    <span style="background: rgba(255, 255, 255, 0.08); border: 1px solid rgba(255, 255, 255, 0.2); padding: 6px 18px; border-radius: 9999px; font-size: 12px; font-weight: 800; color: #ffffff; letter-spacing: 0.1em; text-transform: uppercase;">
      Official Campus Portal
    </span>
    <h1 style="font-size: 48px; font-weight: 900; margin-top: 22px; line-height: 1.15; color: #ffffff; letter-spacing: -0.02em;">
      Excellence in Higher Education & Innovation
    </h1>
    <p style="font-size: 16px; color: #a1a1aa; margin-top: 16px; line-height: 1.6; max-width: 680px; margin-left: auto; margin-right: auto;">
    ...
    <div style="margin-top: 32px; display: flex; justify-content: center; gap: 16px;">
      <a href="#explore" style="background: #ffffff; color: #000000; padding: 13px 30px; border-radius: 12px; font-size: 14px; font-weight: 800; text-decoration: none; display: inline-block;">Explore Programs</a>
      <a href="#contact" style="background: transparent; border: 1px solid rgba(255,255,255,0.25); color: #ffffff; padding: 13px 30px; border-radius: 12px; font-size: 14px; font-weight: 800; text-decoration: none; display: inline-block;">Contact Us</a>
    </div>
  </div>
</section>`;
      ...
      <main className="flex-1 w-full bg-white p-4 sm:p-8 flex flex-col items-center justify-start pb-32">
        ...
        >
          {sections.length === 0 ? (
            ...
            /* Pure Section Rendering inside White Editor Background — No Cards, Borders or Header Lines */
