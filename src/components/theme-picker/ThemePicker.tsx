            ...
            {allTemplates.length > 0 ? (
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-1.5 text-base font-bold text-neutral-900 transition hover:text-blue-600"
                >
                ...
                {templateDropdownOpen && (
                  <div className="absolute left-0 top-full z-50 mt-2 w-64 rounded-xl border border-neutral-200 bg-white p-2 shadow-2xl">
                    ...
                    <div className="mt-1 space-y-1">
                      {allTemplates.map((t) => (
                        ...
                        >
                          <span>{t.name}</span>
                          {t.id === template.id && <Check className="h-3.5 w-3.5 text-white" />}
                        </button>
                      ))}
                    </div>
                  </div>
              ...
              <h1 className="text-base font-bold text-neutral-900">{template.name}</h1>
            )}
          </div>
        </div>
