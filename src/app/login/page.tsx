      ...
      {googleEnabled ? (
        <div className="mx-auto mt-8 max-w-sm px-5">
          <a
            ...
            className="flex w-full items-center justify-center gap-3 rounded-xl border border-brand-ink/15 bg-white px-5 py-3.5 text-[15px] font-semibold text-brand-ink transition hover:border-brand-ink/40 hover:shadow-md"
          >
