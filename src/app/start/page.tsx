  ...
  return (
    <main className="min-h-dvh bg-white">
      <div className="mx-auto max-w-4xl px-5 py-16 sm:py-24">
        <div className="flex flex-wrap items-center justify-between gap-4 border-b border-brand-ink/10 pb-6 mb-8">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-brand-ink px-4 py-2.5 text-sm font-bold text-white shadow-sm transition hover:bg-brand-ink/90"
            >
            ...
            <Link
              href="/admin"
              className="inline-flex items-center gap-1.5 rounded-xl border border-brand-ink/15 bg-white px-3.5 py-2.5 text-sm font-semibold text-brand-ink transition hover:bg-brand-mist"
            >
        ...
        <p className="text-base text-brand-ink/55">
